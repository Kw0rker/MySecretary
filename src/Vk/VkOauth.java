...
public class VkOauth {
    private final static String app_id ="7270298";
    private final static String  redirect_uri ="https://oauth.vk.com/blank.html";
    private final static String request ="https://oauth.vk.com/authorize?client_id="+ app_id +"&display=popup&redirect_uri="+redirect_uri+"&scope=messages&response_type=token&v=5.103&state=123456";
